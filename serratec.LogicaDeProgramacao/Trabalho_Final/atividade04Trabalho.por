...
programa
{
	...
	funcao inicio(){
		...
		escreva("Escolha a operação desejada\n")
          ...
          se(opcao == 1){ //Condição para execução da sequência Fibonacci.
          	escreva("\nDigite a quantidade de números da serie de Fibonacci: ")
          	leia(num)
          ...
          se(opcao == 2){ //Condição para execução do fatorial.
	...
	inteiro indiceFibonacci = 0 //Função sequência Fibonacci.
	...
	inteiro indiceFatorial = 0 //Função Fatorial.
